...
def eliminar_campo(campo_id: int, db: Session = Depends(database.get_db)):
    ...
    db.commit()
    # Nota: la columna física en BD se deja — SQLite no soporta DROP COLUMN fácilmente
    # y los datos históricos quedan intactos. La columna queda huérfana pero no hace daño.
