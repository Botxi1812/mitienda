...
# ── Tabla generica de catalogo ────────────────────────────────────────────────
# Sustituye a Cliente, Articulo, Operario, Departamento, etc.
# Todas las tablas de catalogo comparten esta estructura.
# El campo 'tabla' indica a cual pertenece cada fila.

class Entidad(Base):
    __tablename__ = "entidades"
    id     = Column(Integer, primary_key=True, index=True)
    tabla  = Column(String, nullable=False, index=True)   # ej: "clientes", "articulos"
